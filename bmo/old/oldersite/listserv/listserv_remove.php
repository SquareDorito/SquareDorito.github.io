...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="/Athletics/Mens_Ultimate/oldersite/images/favicon.ico"></link>
        <script src="/Athletics/Mens_Ultimate/oldersite/javascript/jquery-1.6.min.js"></script>
		<script src="/Athletics/Mens_Ultimate/oldersite/javascript/jquery.validate.min.js"></script>
		...
		function disableContent() {
			$("#wait").html("<img src='/Athletics/Mens_Ultimate/oldersite/images/spinner.gif' />");
			$("input").prop('disabled', true);
			$("label").css("color","grey");
		}
    ...
    <body>
        <div id="title"><a href="/Athletics/Mens_Ultimate/"><img src="/Athletics/Mens_Ultimate/oldersite/images/title_brownian_motion.png" alt="Brownian Motion" /></a></div>
		<div id="content">
...
<form id="listservform" action="listservpost.php">
	...
	<img border=1 id="captchaimg" src="http://image.captchas.net?client=demo&random=RandomZufall"><br>
